...
validMoveRookAux b ic 0 ab cd sq = ((onSquare b cd) == Empty) || (isSameColour (onSquare b ab) sq == False) ------ cd not needed
validMoveRookAux b ic n ab cd sq | ((onSquare b cd) /= Empty) = False
