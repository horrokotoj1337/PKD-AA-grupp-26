...
runRookTests = TestList [testvalidMoveRook1, testvalidMoveRook2, testvalidMoveRook3, testvalidMoveRook4, testvalidMoveRook5, testvalidMoveRook6,
                        testvalidMoveRook7, testvalidMoveRook8]


{-
testvalidMoveBishop1 = TestCase (assertEqual "Move from and to the same square" False (validMoveBishop testBoard (1,1) (1,1)))

testvalidMoveBishop2 = TestCase (assertEqual "Bishop Northeast" True (validMoveBishop testBoard (1,1) (1,1)))

testvalidMoveBishop3 = TestCase (assertEqual "Bishop Northwest" True (validMoveBishop testBoard (1,1) (1,1)))

testvalidMoveBishop4 = TestCase (assertEqual "Bishop Southwest" True (validMoveBishop testBoard (1,1) (1,1)))

testvalidMoveBishop5 = TestCase (assertEqual "Bishop Southeast" True (validMoveBishop testBoard (1,1) (1,1)))

testvalidMoveBishop6 = TestCase (assertEqual "Can another piece move like a Bishop?" True (validMoveBishop testBoard (1,1) (1,1)))

testvalidMoveBishop7 = TestCase (assertEqual "Move through another piece?" False (validMoveBishop testBoard (1,1) (1,1)))

testvalidMoveBishop8 = TestCase (assertEqual "Can Bishop move like Rook?" False (validMoveBishop testBoard (1,1) (1,1)))
